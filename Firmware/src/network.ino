...
void setUploadSettings() {
  ...
  tsfPM1 = server->arg("tsfPM1").toInt();
  tsfPM2 = server->arg("tsfPM2").toInt();
  ...
  senseBoxPM1Id = server->arg("sbPM1Id");
  senseBoxPM2Id = server->arg("sbPM2Id");
...
void getUploadSettings() {
  ...
  response += String(tsfPM1) + ",";
  response += String(tsfPM2) + ",";
  ...
  response += senseBoxPM1Id + ",";
  response += senseBoxPM2Id + ",";
